...
echo "<p>{$userFirstName} {$userLastName} <span class='tag'> tem {$userAge} </span> anos </p>";

$userEmail = "<p>kl.solutions.ti@gmail.com";

echo $userEmail;

//variavel variavel

$company = "KL_Solutions";
$$company = "Treinamentos";

echo "<h3>{$company} {$KL_Solutions} </h3>";
